export default class ButtonBar {
    ...
    drawBidButtons() {    
        ...
        for (let i = 2; i < 6; i++) {
            ...
            this.buttons[i].on('pointerover', function () {
                self.r[i - 1].setFillStyle(0x000000);
            });      
            
            this.buttons[i].on('pointerout', function () {
                self.r[i - 1].setFillStyle(0x555555);
            });            
            xo = xo + 100;
        }
    ...
    activateBidButtons(highBid, dealer) {
        if (this.buttons.length == 2) { // if all we have is a Deal and Link button
    ...
    hideBidButtons() {
        this.game.tweens.add({
            targets: [this.buttons[2], this.buttons[3], this.buttons[4], this.buttons[5], this.r[1], this.r[2], this.r[3], this.r[4]],
            alpha: 0,
            ease: 'Power1',
            duration: 300
